    ...
    () => [
      {
        ...
        accessorKey: "code",
        size: 120,
        header: () => <p className="column-title ml-2 rounded-full">Code</p>,
        cell: ({ getValue }) => {
          const code = getValue<string>();

          return code ? (
            <Badge className=" justify-center bg-red-600 text-white hover:bg-red-600 rounded-full md:text-sm">
               {code}
            </Badge>
          ) : (
      ...
      },
      {
        ...
        cell: ({ getValue }) => {
          ...
          return (
            <Badge className="justify-center bg-green-600 text-white hover:bg-green-600 rounded-full text-sm md:text-sm ">
              {total ?? 0}
            </Badge>
          );
        },
